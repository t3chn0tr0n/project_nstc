...
function lat_selected() {
  ...
  document.getElementById('selection').innerHTML = "&nbsp;&nbsp;&nbsp;(Lateral is selected)";
  document.getElementById('stream').innerHTML = "<option selected disabled value=\"\">Select stream</option><option value=\"B-TECH\">B-TECH</option>";
}
  ...
  $("#viewfile").click(function () {
    if (document.getElementById("inputfile").value != "") {
      ...
      if (
        ...
        if ((mid_checked && Middle_Name != "") || (!mid_checked && Middle_Name == "")) {
          alert(document.getElementById('customCheck1').checked + Middle_Name)
          $("#error_csv_upload").html("<i class=\"fas fa-heart-broken\"></i> Input fields are incomplete!!!");
        } else {
          ...
          rdr.onload = function (e) {
            ...
            if (
              ...
              $("#error_csv_upload").append("<i class=\"fas fa-heart-broken\"></i> Entered column no. and columns in CSV does not match!!");
            } else if (
              id_card <= 0 ||
              Roll_no <= 0 ||
              First_Name <= 0 ||
              ...
              $("#error_csv_upload").append("<i class=\"fas fa-bug\"></i> Column numbers must be greater than 1!!");
            } else {
              ...
              for (row = row; row < therows.length; row++) {
                ...
                if (colcount <= 7) {
                  ...
                  if (
                    typeof (columns[id_card - 1]) == "undefined" || columns[id_card - 1] == "" ||
                    typeof (columns[Roll_no - 1]) == "undefined" || columns[Roll_no - 1] == "" ||
                    typeof (columns[First_Name - 1]) == "undefined" || columns[First_Name - 1] == "" ||
                    (!mid_checked && typeof (columns[Middle_Name - 1]) == "undefined") ||
                    typeof (columns[Last_Name - 1]) == "undefined" || columns[Last_Name - 1] == "" ||
                    typeof (columns[Email_column - 1]) == "undefined" || columns[Email_column - 1] == "" ||
                    typeof (columns[Mentor_id - 1]) == "undefined" || columns[Mentor_id - 1] == ""
                  ) {
              ...
              if (c > 0) {
                $("#error_csv_upload").append("<i class=\"fas fa-bug\"></i> There are " + c + " error in csv");
                document.getElementById("upload_db").disabled = true;
        ...
        $("#error_csv_upload").html("<i class=\"fas fa-exclamation-triangle\"></i> Input fields are incomplete!!!");
      }
    } else {
      $("#error_csv_upload").html("<i class=\"fas fa-exclamation-triangle\"></i> NO FILE IS SELECTED!!!");
    }
  });
