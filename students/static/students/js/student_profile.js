...
function change(div_id_1, div_id_2, id) {
  ...
  document.getElementById("mob_no_submit").innerHTML =
    '&nbsp&nbsp&nbsp<span class="text-danger">Phone no must be 10 digit!!</span>&nbsp&nbsp<input type="button" class="btn btn-danger btn-sm" onclick="cancel(\'mob_no_change\', \'mob_no_submit\', \'mob_no\');" value="Cancel" />';
}
